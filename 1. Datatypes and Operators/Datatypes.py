...
Name = "Nikita"    #positive and negative formats
...
dict1 = {'Name': 'Nikita', 'Age': 22, 'bike': 'Beneli'}
print(dict1)
dict1['Name']
print(dict1['Age'])   
print(dict1['bike'])
